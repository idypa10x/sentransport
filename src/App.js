...
function App() {
  const lignes = [
    ...
    { id: 8, numero: "42", depart: "Liberte 6", arrivee: "Dieuppeul", arrets: 13, couleur: "#d35400" },
    { id: 9, numero: "17", depart: "Sicap", arrivee: "Medina", arrets: 8, couleur: "#27ae60" },
    { id: 10, numero: "5", depart: "HLM", arrivee: "Sandaga", arrets: 15, couleur: "#2c3e50" },
  ];
